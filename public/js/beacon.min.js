! function(e) {
  ...
  function i(e, t, n, i) {
    ...
    if (c(d, v.memory), v.redirectCount = e.navigation && e.navigation.redirectCount, v.documentWriteIntervention = a(), v.firstPaint = o("first-paint"), v.firstContentfulPaint = o("first-contentful-paint"), v.errorCount = window.__cfErrCount || 0, i && (v.largestContentfulPaint = void 0 !== i.lcp ? i.lcp : -1, v.firstInputDelay = void 0 !== i.fid ? i.fid : -1, v.cumulativeLayoutShift = void 0 !== i.cls ? i.cls : -1), "function" == typeof e.getEntriesByType) {
  ...
  ! function() {
    ...
    document.addEventListener("visibilitychange", function() {
      "hidden" === document.visibilityState && !o && a && (o = !0, m())
    });
    var s = {
        lcp: void 0,
        cls: void 0,
    ...
    if ("function" == typeof PerformanceObserver && (d.getLCP(c), d.getFID(c), PerformanceObserver.supportedEntryTypes && PerformanceObserver.supportedEntryTypes.includes("layout-shift") && d.getCLS(c)), t) {
      ...
      var v = function() {
          ...
          if (t && r) {
            ...
            a.forEach(function(e, n) {
              t.resources = e, 0 != n && (t.bypassTiming = !0), r && (1 === r.r && (t.resources = []), f.sendObjectBeacon(o, t), void 0 !== r.forward && void 0 !== r.forward.url && f.sendObjectBeacon(o, t, function() {}, !1, r.forward.url))
            })
          }
        },
        m = function() {
          var t = i(e, n, r, s);
          t.resources = [], delete t.tempResources, t.eventType = u.EventType.Additional, r && f.sendObjectBeacon("req_id=" + r.rayId, t, function() {}, !0)
        },
        y = function() {
          a = !0;
  ...
  function r(e, t, n, r, i) {
    ...
    if (navigator && "function" == typeof navigator.sendBeacon && a && r) {
      ...
      }), f.open("POST", o), f.setRequestHeader("content-type", "application/json"), f.send(c)
    }
  }
  ...
  var r, i, o = function() {
    ...
    p = function(e) {
      ...
      u || (d(), u = !0), addEventListener("visibilitychange", function(t) {
        var n = t.timeStamp;
  ...
  t.getCLS = v, t.getFCP = y, t.getFID = g, t.getLCP = h, t.getTTFB = S
}, function(e, t, n) {
  "use strict";
