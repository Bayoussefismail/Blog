...
<section class=" section topics" style="">
  <h1 class="oversize rellax slide-top" data-rellax-speed="-0.5" style="transform: translate3d(0px, -3px, 0px); text-align:left!important; padding-left: 22%!important; margin-top:40%;">Category : {{$title}}</h1>
...
<div class="container2">
    ...
    <div class="card-grid-space">
      ...
      <a id="image" class="card1" href="{{route('post.single', ['slug' => $post -> slug])}}" style="background-image: url('{{config('image.base_url') .$post->feature}}')">
        <div>
          <h1>{{$post->title}}</h1>
          <p></p>
